...
parser.add_argument(
    ...
    type=str,
    default="resume",
    help='Either "resume" (from an out_dir) or a gpt2 variant',
)
parser.add_argument(
    "--out_dir", type=str, default="out", help="Output directory for checkpoints"
)
parser.add_argument(
    "--num_samples", type=int, default=1, help="Number of samples to draw"
)
parser.add_argument(
...
parser.add_argument(
    "--compile", action="store_true", help="Use PyTorch 2.0 compilation"
)
